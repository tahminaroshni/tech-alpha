  ...
  return (
    <div
      ...
      <div className='container mx-auto  flex flex-col gap-3 items-start'>
        <h2
          className='image-title space-font uppercase text-5xl text-slate-50'>{image.title}
        </h2>
        ...
        <Link
          ...
          <span
            className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full z-[2] text-center text-slate-50 hover:text-cyan-50 hover:border-cyan-50'>{image.cta}</span>
        </Link>
      </div>
    </div>
  );
