...
const Navbar = () => {
  return (
    <nav className="navbar bg-slate-500 px-10 h-20 flex items-center">
      <div className="container mx-auto flex justify-between items-center">
        <div className="left">
          <h4 className="logo text-2xl font-semibold italic">tech<span className="text-cyan-400">Alpha</span></h4>
        </div>
        <div className="right flex gap-10 items-center text-lg">
          ...
          <Link to='/cart' >
            ...
            <span className="cart-count absolute h-8 w-8 flex justify-center items-center rounded-full bg-rose-500 text-rose-50  top-2 right-4 font-semibold">10</span>
          </Link>
        </div>
      </div>
    </nav>
